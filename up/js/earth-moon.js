...
Earth.prototype.createGlobe = function()
{
	...
	var surfaceMap = THREE.ImageUtils.loadTexture( "image/earth_surface_2048.jpg" );
	var normalMap = THREE.ImageUtils.loadTexture( "image/earth_normal_2048.jpg" );
	var specularMap = THREE.ImageUtils.loadTexture( "image/earth_specular_2048.jpg" );
...
{
	// Create our clouds
	var cloudsMap = THREE.ImageUtils.loadTexture( "image/earth_clouds_1024.png" );
...
{
	var MOONMAP = "./image/moon_1024.jpg";
