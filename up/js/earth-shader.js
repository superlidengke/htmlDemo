...
Earth.prototype.createGlobe = function() {
	// Create our Earth with nice texture - normal map for elevation,specular
	// highlights
	var surfaceMap = THREE.ImageUtils
			.loadTexture("image/earth_surface_2048.jpg");
	var normalMap = THREE.ImageUtils
			.loadTexture("image/earth_normal_2048.jpg");
	var specularMap = THREE.ImageUtils
			.loadTexture("image/earth_specular_2048.jpg");
	var shader = THREE.ShaderUtils.lib["normal"], uniforms = THREE.UniformsUtils
...
Earth.prototype.createClouds = function() {
	// Create our clouds
	var cloudsMap = THREE.ImageUtils
			.loadTexture("./image/earth_clouds_1024.png");
